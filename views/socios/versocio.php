...
<div class="cardsmall">
<h1 class="titulo mt-5"><b>Socios</b></h1>
                ...
                <div class="col">
                    <div class="card h-100 shadow-sm">
                        <div class="card-body d-flex flex-column">
                            ...
                            <?php if (method_exists($socio, 'getFoto') && $socio->getFoto()): ?>
                                    <img src="/carpeta2/uploads/fotos/<?= htmlspecialchars($socio->getFoto()) ?>"
                                         alt="Foto de <?= htmlspecialchars($socio->getNombre()) ?>"
                            ...
                            <p class="card-text">
                                ...
                                <b>Registrado:</b> <?= date('d/m/Y', strtotime($socio->getFecharegistro())) ?><br>
                                <b>Clase:</b> <?= htmlspecialchars($socio->getClase()) ?><br>
